...
var dllImportDefs = []importTable{
    ...
    /*248*/ {"PyType_Type", 0},
    /*249*/ {"_PyType_Name", 0},
    /*250*/ {"PyType_GetModule", 0},
    /*251*/ {"PyType_Check", 0},
    /*252*/ {"PyType_CheckExact", 0},
    /*253*/ {"PyType_ClearCache", 0},
    /*254*/ {"PyType_GetFlags", 0},
    /*255*/ {"PyType_Modified", 0},
    /*256*/ {"PyType_HasFeature", 0},
    /*257*/ {"PyType_IS_GC", 0},
    /*258*/ {"PyType_IsSubtype", 0},
    /*259*/ {"PyType_GenericAlloc", 0},
    /*260*/ {"PyType_GenericNew", 0},
    /*261*/ {"PyType_Ready", 0},
    /*262*/ {"PyType_GetSlot", 0},
    /*263*/ {"PyType_FromSpecWithBases", 0},
    /*264*/ {"PyType_FromSpec", 0},
    /*265*/ {"PyList_Type", 0},
    /*266*/ {"PyList_Check", 0},
    /*267*/ {"PyList_CheckExact", 0},
    /*268*/ {"PyList_New", 0},
    /*269*/ {"PyList_SetItem", 0},
    /*270*/ {"PyList_GetItem", 0},
    /*271*/ {"PyList_GetSlice", 0},
    /*272*/ {"PyList_SetSlice", 0},
    /*273*/ {"PyList_Size", 0},
    /*274*/ {"PyList_Insert", 0},
    /*275*/ {"PyList_Append", 0},
    /*276*/ {"PyList_Sort", 0},
    /*277*/ {"PyList_Reverse", 0},
    /*278*/ {"PyList_AsTuple", 0},
    /*279*/ {"PyBool_Type", 0},
    /*280*/ {"PyBool_FromLong", 0},
    /*281*/ {"PyBool_Check", 0},
    /*282*/ {"PyExc_Exception", 0},
    /*283*/ {"PyExc_ValueError", 0},
    /*284*/ {"PyErr_Clear", 0},
    /*285*/ {"PyErr_PrintEx", 0},
    /*286*/ {"PyErr_Print", 0},
    /*287*/ {"PyErr_WriteUnraisable", 0},
    /*288*/ {"PyErr_SetString", 0},
    /*289*/ {"PyErr_SetObject", 0},
    /*290*/ {"PyErr_Format", 0},
    /*291*/ {"PyErr_FormatV", 0},
    /*292*/ {"PyErr_SetNone", 0},
    /*293*/ {"PyErr_BadArgument", 0},
    /*294*/ {"PyErr_NoMemory", 0},
    /*295*/ {"PyErr_SetFromErrno", 0},
    /*296*/ {"PyErr_SetFromErrnoWithFilenameObject", 0},
    /*297*/ {"PyErr_SetFromErrnoWithFilenameObjects", 0},
    /*298*/ {"PyErr_SetFromErrnoWithFilename", 0},
    /*299*/ {"PyErr_SetFromWindowsErr", 0},
    /*300*/ {"PyErr_SetExcFromWindowsErr", 0},
    /*301*/ {"PyErr_SetFromWindowsErrWithFilename", 0},
    /*302*/ {"PyErr_SetExcFromWindowsErrWithFilenameObject", 0},
    /*303*/ {"PyErr_SetExcFromWindowsErrWithFilenameObjects", 0},
    /*304*/ {"PyErr_SetExcFromWindowsErrWithFilename", 0},
    /*305*/ {"PyErr_SetImportError", 0},
    /*306*/ {"PyErr_SyntaxLocationObject", 0},
    /*307*/ {"PyErr_SyntaxLocationEx", 0},
    /*308*/ {"PyErr_SyntaxLocation", 0},
    /*309*/ {"PyErr_BadInternalCall", 0},
    /*310*/ {"PyErr_WarnEx", 0},
    /*311*/ {"PyErr_SetImportErrorSubclass", 0},
    /*312*/ {"PyErr_WarnExplicitObject", 0},
    /*313*/ {"PyErr_WarnExplicit", 0},
    /*314*/ {"PyErr_WarnFormat", 0},
    /*315*/ {"PyErr_ResourceWarning", 0},
    /*316*/ {"PyErr_Occurred", 0},
    /*317*/ {"PyErr_ExceptionMatches", 0},
    /*318*/ {"PyErr_GivenExceptionMatches", 0},
    /*319*/ {"PyErr_Fetch", 0},
    /*320*/ {"PyErr_Restore", 0},
    /*321*/ {"PyErr_NormalizeException", 0},
    /*322*/ {"PyErr_GetExcInfo", 0},
    /*323*/ {"PyErr_SetExcInfo", 0},
    /*324*/ {"PyErr_CheckSignals", 0},
    /*325*/ {"PyErr_SetInterrupt", 0},
    /*326*/ {"PySignal_SetWakeupFd", 0},
    /*327*/ {"PyErr_NewException", 0},
    /*328*/ {"PyErr_NewExceptionWithDoc", 0},
    /*329*/ {"PyException_GetTraceback", 0},
    /*330*/ {"PyException_SetTraceback", 0},
    /*331*/ {"PyException_GetContext", 0},
    /*332*/ {"PyException_SetContext", 0},
    /*333*/ {"PyException_GetCause", 0},
    /*334*/ {"PyException_SetCause", 0},
    /*335*/ {"PyUnicodeDecodeError_Create", 0},
    /*336*/ {"PyUnicodeEncodeError_Create", 0},
    /*337*/ {"PyUnicodeTranslateError_Create", 0},
    /*338*/ {"PyUnicodeDecodeError_GetEncoding", 0},
    /*339*/ {"PyUnicodeEncodeError_GetEncoding", 0},
    /*340*/ {"PyUnicodeDecodeError_GetObject", 0},
    /*341*/ {"PyUnicodeEncodeError_GetObject", 0},
    /*342*/ {"PyUnicodeTranslateError_GetObject", 0},
    /*343*/ {"PyUnicodeDecodeError_GetStart", 0},
    /*344*/ {"PyUnicodeEncodeError_GetStart", 0},
    /*345*/ {"PyUnicodeTranslateError_GetStart", 0},
    /*346*/ {"PyUnicodeDecodeError_SetStart", 0},
    /*347*/ {"PyUnicodeEncodeError_SetStart", 0},
    /*348*/ {"PyUnicodeTranslateError_SetStart", 0},
    /*349*/ {"PyUnicodeDecodeError_GetEnd", 0},
    /*350*/ {"PyUnicodeEncodeError_GetEnd", 0},
    /*351*/ {"PyUnicodeTranslateError_GetEnd", 0},
    /*352*/ {"PyUnicodeDecodeError_SetEnd", 0},
    /*353*/ {"PyUnicodeEncodeError_SetEnd", 0},
    /*354*/ {"PyUnicodeTranslateError_SetEnd", 0},
    /*355*/ {"PyUnicodeDecodeError_GetReason", 0},
    /*356*/ {"PyUnicodeEncodeError_GetReason", 0},
    /*357*/ {"PyUnicodeTranslateError_GetReason", 0},
    /*358*/ {"PyUnicodeDecodeError_SetReason", 0},
    /*359*/ {"PyUnicodeEncodeError_SetReason", 0},
    /*360*/ {"PyUnicodeTranslateError_SetReason", 0},
    /*361*/ {"PyInstanceMethod_Type", 0},
    /*362*/ {"PyInstanceMethod_New", 0},
    /*363*/ {"PyInstanceMethod_Function", 0},
    /*364*/ {"PyCFunction_New", 0},
    /*365*/ {"Py_GetPath", 0},
    /*366*/ {"Py_GetPythonHome", 0},
    /*367*/ {"_py_fopen_obj", 0},
    /*368*/ {"Py_BuildValue", 0},
    /*369*/ {"Py_GetPlatform", 0},
    /*370*/ {"Py_GetVersion", 0},
    /*371*/ {"Py_GetCompiler", 0},
    /*372*/ {"Py_GetBuildInfo", 0},
    /*373*/ {"Py_GetExecPrefix", 0},
    /*374*/ {"Py_GetProgramFullPath", 0},
    /*375*/ {"Py_GetPrefix", 0},
    /*376*/ {"Py_GetCopyright", 0},
    /*377*/ {"Py_SetStandardStreamEncoding", 0},
    /*378*/ {"Py_NewInterpreter", 0},
    /*379*/ {"Py_EndInterpreter", 0},
    /*380*/ {"Py_AddPendingCall", 0},
    /*381*/ {"Py_tracefunc", 0},
    /*382*/ {"Py_CompileString", 0},
    /*383*/ {"Py_CompileStringFlags", 0},
    /*384*/ {"Py_CompileStringObject", 0},
    /*385*/ {"Py_CompileStringExFlags", 0},
    /*386*/ {"Py_eval_input", 0},
    /*387*/ {"Py_file_input", 0},
    /*388*/ {"Py_single_input", 0},
    /*389*/ {"Py_EnterRecursiveCall", 0},
    /*390*/ {"Py_ReprEnter", 0},
    /*391*/ {"Py_ReprLeave", 0},
    /*392*/ {"Py_FatalError", 0},
    /*393*/ {"Py_Exit", 0},
    /*394*/ {"Py_AtExit", 0},
    /*395*/ {"Py_ExitStatusException", 0},
    /*396*/ {"Py_FdIsInteractive", 0},
    /*397*/ {"Py_InitializeFromConfig", 0},
    /*398*/ {"Py_PreInitialize", 0},
    /*399*/ {"Py_PreInitializeFromArgs", 0},
    /*400*/ {"Py_PreInitializeFromBytesArgs", 0},
    /*401*/ {"Py_RunMain", 0},
    /*402*/ {"Py_LeaveRecursiveCall", 0},
    /*403*/ {"PyMethod_Type", 0},
    /*404*/ {"PyMethod_Check", 0},
    /*405*/ {"PyMethod_New", 0},
    /*406*/ {"PyMethod_Function", 0},
    /*407*/ {"PyMethod_Self", 0},
    /*408*/ {"PyState_FindModule", 0},
    /*409*/ {"PyState_AddModule", 0},
    /*410*/ {"PyState_RemoveModule", 0},
}
const (
    Py_NoneStruct = 0
    Py_Initialize = 1
    ...
    PyType_Type = 248
    PyType_Name = 249
    PyType_GetModule = 250
    PyType_Check = 251
    PyType_CheckExact = 252
    PyType_ClearCache = 253
    PyType_GetFlags = 254
    PyType_Modified = 255
    PyType_HasFeature = 256
    PyType_IS_GC = 257
    PyType_IsSubtype = 258
    PyType_GenericAlloc = 259
    PyType_GenericNew = 260
    PyType_Ready = 261
    PyType_GetSlot = 262
    PyType_FromSpecWithBases = 263
    PyType_FromSpec = 264
    PyList_Type = 265
    PyList_Check = 266
    PyList_CheckExact = 267
    PyList_New = 268
    PyList_SetItem = 269
    PyList_GetItem = 270
    PyList_GetSlice = 271
    ...
    PyBool_Check = 281
    PyExc_Exception = 282
    PyExc_ValueError = 283
    PyErr_Clear = 284
    PyErr_PrintEx = 285
    PyErr_Print = 286
    PyErr_WriteUnraisable = 287
    PyErr_SetString = 288
    PyErr_SetObject = 289
    PyErr_Format = 290
    PyErr_FormatV = 291
    PyErr_SetNone = 292
    PyErr_BadArgument = 293
    PyErr_NoMemory = 294
    PyErr_SetFromErrno = 295
    PyErr_SetFromErrnoWithFilenameObject = 296
    PyErr_SetFromErrnoWithFilenameObjects = 297
    PyErr_SetFromErrnoWithFilename = 298
    PyErr_SetFromWindowsErr = 299
    PyErr_SetExcFromWindowsErr = 300
    PyErr_SetFromWindowsErrWithFilename = 301
    PyErr_SetExcFromWindowsErrWithFilenameObject = 302
    PyErr_SetExcFromWindowsErrWithFilenameObjects = 303
    PyErr_SetExcFromWindowsErrWithFilename = 304
    PyErr_SetImportError = 305
    PyErr_SyntaxLocationObject = 306
    PyErr_SyntaxLocationEx = 307
    PyErr_SyntaxLocation = 308
    PyErr_BadInternalCall = 309
    PyErr_WarnEx = 310
    PyErr_SetImportErrorSubclass = 311
    PyErr_WarnExplicitObject = 312
    PyErr_WarnExplicit = 313
    PyErr_WarnFormat = 314
    PyErr_ResourceWarning = 315
    PyErr_Occurred = 316
    PyErr_ExceptionMatches = 317
    PyErr_GivenExceptionMatches = 318
    PyErr_Fetch = 319
    PyErr_Restore = 320
    PyErr_NormalizeException = 321
    PyErr_GetExcInfo = 322
    PyErr_SetExcInfo = 323
    PyErr_CheckSignals = 324
    PyErr_SetInterrupt = 325
    PySignal_SetWakeupFd = 326
    PyErr_NewException = 327
    PyErr_NewExceptionWithDoc = 328
    PyException_GetTraceback = 329
    PyException_SetTraceback = 330
    PyException_GetContext = 331
    PyException_SetContext = 332
    PyException_GetCause = 333
    PyException_SetCause = 334
    PyUnicodeDecodeError_Create = 335
    PyUnicodeEncodeError_Create = 336
    PyUnicodeTranslateError_Create = 337
    PyUnicodeDecodeError_GetEncoding = 338
    PyUnicodeEncodeError_GetEncoding = 339
    PyUnicodeDecodeError_GetObject = 340
    PyUnicodeEncodeError_GetObject = 341
    PyUnicodeTranslateError_GetObject = 342
    PyUnicodeDecodeError_GetStart = 343
    PyUnicodeEncodeError_GetStart = 344
    PyUnicodeTranslateError_GetStart = 345
    PyUnicodeDecodeError_SetStart = 346
    PyUnicodeEncodeError_SetStart = 347
    PyUnicodeTranslateError_SetStart = 348
    PyUnicodeDecodeError_GetEnd = 349
    PyUnicodeEncodeError_GetEnd = 350
    PyUnicodeTranslateError_GetEnd = 351
    PyUnicodeDecodeError_SetEnd = 352
    PyUnicodeEncodeError_SetEnd = 353
    PyUnicodeTranslateError_SetEnd = 354
    PyUnicodeDecodeError_GetReason = 355
    PyUnicodeEncodeError_GetReason = 356
    PyUnicodeTranslateError_GetReason = 357
    PyUnicodeDecodeError_SetReason = 358
    PyUnicodeEncodeError_SetReason = 359
    PyUnicodeTranslateError_SetReason = 360
    PyInstanceMethod_Type = 361
    PyInstanceMethod_New = 362
    PyInstanceMethod_Function = 363
    PyCFunction_New = 364
    Py_GetPath = 365
    Py_GetPythonHome = 366
    py_fopen_obj = 367
    Py_BuildValue = 368
    Py_GetPlatform = 369
    Py_GetVersion = 370
    Py_GetCompiler = 371
    Py_GetBuildInfo = 372
    Py_GetExecPrefix = 373
    Py_GetProgramFullPath = 374
    Py_GetPrefix = 375
    Py_GetCopyright = 376
    Py_SetStandardStreamEncoding = 377
    Py_NewInterpreter = 378
    Py_EndInterpreter = 379
    Py_AddPendingCall = 380
    Py_tracefunc = 381
    Py_CompileString = 382
    Py_CompileStringFlags = 383
    Py_CompileStringObject = 384
    Py_CompileStringExFlags = 385
    Py_eval_input = 386
    Py_file_input = 387
    Py_single_input = 388
    Py_EnterRecursiveCall = 389
    Py_ReprEnter = 390
    Py_ReprLeave = 391
    Py_FatalError = 392
    Py_Exit = 393
    Py_AtExit = 394
    Py_ExitStatusException = 395
    Py_FdIsInteractive = 396
    Py_InitializeFromConfig = 397
    Py_PreInitialize = 398
    Py_PreInitializeFromArgs = 399
    Py_PreInitializeFromBytesArgs = 400
    Py_RunMain = 401
    Py_LeaveRecursiveCall = 402
    PyMethod_Type = 403
    PyMethod_Check = 404
    PyMethod_New = 405
    PyMethod_Function = 406
    PyMethod_Self = 407
    PyState_FindModule = 408
    PyState_AddModule = 409
    PyState_RemoveModule = 410
)